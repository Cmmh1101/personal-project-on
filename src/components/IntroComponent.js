    ...
    <div className="container py-5">
      <div className="row py-5">
        <div className="col-md-6 col-lg-5 mx-lg-auto">
          ...
          <p className="my-3">
            <i class="fa fa-commenting-o" aria-hidden="true" /> Comments
          </p>
          <p className="my-3">
            <i class="fa fa-calendar" aria-hidden="true" /> Calendar of
            activities and important events
          </p>
          <p className="my-3">
            <i class="fa fa-file-image-o" aria-hidden="true" /> Share photos and
            videos with your group
          </p>
          <p className="my-3">
            <i class="fa fa-list" aria-hidden="true" /> Books, movies, recipes,
            and more Recommendations
          </p>
          <p className="my-3">
            <i class="fa fa-comments" aria-hidden="true" /> Instant messages
          </p>
        </div>
